...
const addToCartButtonBelowCarousel = document.querySelector('.add-to-cart-below-carousel');

if (addToCartButtonBelowCarousel) {
  addToCartButtonBelowCarousel.addEventListener('click', addToCartBelowCarousel);
}

function addToCartBelowCarousel(event) {
  // Implement your logic for adding the carousel item to the cart here
  console.log('Adding carousel item to cart...');
}
